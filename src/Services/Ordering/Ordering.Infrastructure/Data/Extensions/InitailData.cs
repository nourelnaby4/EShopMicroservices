...
internal class InitialData
{
    ...
    new List<Customer>
    {
        ...
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "saed", "saed@gmail.com")
    };
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("mohamed", "ahmed", "mohamed@gmail.com", "alfmaskan No:4", "egypt", "cairo", "38050");
            var address2 = Address.Of("saed", "salem", "saed@gmail.com", "giza No:1", "egypt", "cairo", "08050");

            var payment1 = Payment.Of("mohamed", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("saed", "8885555555554444", "06/30", "222", 2);
